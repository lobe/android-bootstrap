...
public class OnDragTouchListener implements View.OnTouchListener {
    ...
    public OnDragTouchListener(ImageView view) {
    ...
    public OnDragTouchListener(ImageView view, View parent, OnDragActionListener onDragActionListener) {
    ...
    public void initListener(ImageView view, View parent) {
        mView = view;
        mParent = parent;
        isDragging = false;
        isInitialized = false;
